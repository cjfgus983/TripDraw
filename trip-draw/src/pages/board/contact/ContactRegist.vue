          ...
          <div class="mb-8">
            <div class="flex items-center mb-4">
              <input
                ...
                id="isPrivate"
                v-model="isPrivate"
                class="w-4 h-4 text-[#9FB3DF] border-[#BDDDE4] rounded focus:ring-[#9EC6F3]"
              />
              <label for="isPrivate" class="ml-2 text-gray-700"
                >비밀글로 설정</label
              >
            </div>
  
            <!-- 비밀번호 입력 -->
            <div v-if="isPrivate" class="transition-all duration-300">
